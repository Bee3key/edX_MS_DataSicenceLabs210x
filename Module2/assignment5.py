...
dpath = os.path.join('/home', 'dj', 'PycharmProjects', 'ML_DAT201x_MS',
                     'DAT210x', 'Module2', 'Datasets', 'census.data')
cnam = ['education', 'age', 'capital-gain', 'race', 'capital-loss',
...
df = pd.read_csv(dpath, sep=',', names=cnam)
